...
public class DirectionFinder {
    ...
    private static final String GOOGLE_API_KEY = "AIzaSyBN3MQymPoozeYYBRJg-Vd_ZVN7Sbrl3vs";
    ...
    private String createUrl() throws UnsupportedEncodingException {
        ...
        return DIRECTION_URL_API + "origin=" + urlOrigin + "&destination=" + urlDestination + "&key=" + GOOGLE_API_KEY + "&mode=" + mode;
    }
